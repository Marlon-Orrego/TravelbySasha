...
router.post('/usuarios', async (req, res) => {
    try {
        ...
        console.log(user)
        const validaCorreo = await getDocumentsWithFilter("sasha", "usuarios", { correo: user.correo })
        const validaId = await getDocumentsWithFilter("sasha", "usuarios", { IdUsuario: user.IdUsuario })
